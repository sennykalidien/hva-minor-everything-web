...
And when the scenario occurs, you can configure what alert you want to give. In this tutorial a LED will light up.
...
**2 - Settings page - configure the in- and output of our board**
