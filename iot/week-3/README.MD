...
4. [Set up the software](#4-ser-up-the-software)
...
## 7. Magic!
That should do the trick! Give it a try, upload the code to your NodeMCU board and check if it connects succesfully with your server.
